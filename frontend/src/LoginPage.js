  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#FFFCFB] px-4">
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl border-t-4 border-[#093FB4]">
        <h2 className="text-3xl font-bold text-[#093FB4] mb-2 text-center">Welcome Back</h2>
        <p className="text-sm text-gray-600 text-center mb-6">
          Log in to your account and continue your analysis journey.
        </p>

        {error && (
          <div className="bg-[#FFD8D8] text-red-700 text-sm px-4 py-2 rounded mb-4 text-center shadow-inner">
            {error}
          </div>
        )}
        ...
        <div className="mt-6 text-center text-sm text-gray-600">
          ...
          <Link to="/signup" className="text-[#ED3500] font-semibold hover:underline">
            Signup here
          </Link>
        </div>

        <div className="mt-6 bg-[#FFD8D8] p-3 rounded-lg text-center text-sm text-[#093FB4] shadow-inner">
          Secure and simple access to your reports anytime.
        </div>
      </div>
    </div>
  );
